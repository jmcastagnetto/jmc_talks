...
*Fuente*: https://clauswilke.com/dataviz/aesthetic-mapping.html
...
<small>
*Fuente*: https://clauswilke.com/dataviz/directory-of-visualizations.html
</small>
...
<small>
*Fuente*: https://clauswilke.com/dataviz/introduction.html
</small>
...
reg <- ejec_presup %>%
  ...
  mutate(
    ...
    ym = glue::glue("{año_eje}-{mes}")
  )

reg_sum <- reg %>%
  filter(mes_eje != 0) %>%
  group_by(dpto, año_eje, mes) %>%
  summarise(
...
- [Fundamentals of Data Visualization](https://clauswilke.com/dataviz/), C. O. Wilke
...
- Contacto:
  ...
  - Ejemplos del #30diasdegraficos del 2020:
      - Hilo en Twitter: https://twitter.com/jmcastagnetto/status/1261020232786870272
      - Repositorio con el código: https://github.com/jmcastagnetto/mis-30-dias-de-graficos
