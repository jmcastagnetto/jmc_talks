...
## Veamos en más detalle a San Martín, La Libertad, Callao y Piura
...
p2 <- ggplot(sm_cases, aes(x = date, y = change)) +
  ...
  labs(
    title = "Nuevos casos positivos por COVID-19 en San Martín",
    subtitle = "Modelo usando GAM: y ~ s(x, bs = 'cs')",
    x = "",
    y = "Número de casos"
  )
...
- **Visualizar los datos**: es crítico para poder entender el problema que tratamos de resolver, y para decidir si podemos o no hacerlo con la información a mano.
